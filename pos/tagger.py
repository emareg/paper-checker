...
POS_TAG_ADJECTIVE = 'j'
POS_TAG_ADVERB = 'a'
POS_TAG_CONJUNCTION = 'c'
POS_TAG_NOUN = 'n'
POS_TAG_NOUN_PL = 'N'
POS_TAG_VERB = 'v'
POS_TAG_BASE_VERB = 'b'
POS_TAG_MODAL_VERB = 'm'
POS_TAG_DETERMINER = 'd'
POS_TAG_SYMBOL = 's'
POS_TAG_PREPOSITION = 'p'
POS_TAG_PRONOUN = 'P'
POS_TAG_TO = 't'
